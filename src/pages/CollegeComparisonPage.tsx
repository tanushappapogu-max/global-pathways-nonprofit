...
<Card className="mb-8 bg-white border border-gray-200 shadow-lg">
  <CardHeader>
    <CardTitle className="flex items-center text-black text-2xl">
  ...
  <CardContent>
    <div className="relative">
      ...
      <Input
        ...
        className="pl-10 bg-gray-50 border-gray-300 text-gray-900 placeholder:text-gray-500 h-12"
      />
                      ...
                      >
                        <Card className="bg-white border border-gray-200 hover:border-blue-400 backdrop-blur-sm shadow-lg transition-all duration-300 rounded-2xl h-full flex flex-col">
                          <CardHeader className="pb-4">
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                <CardTitle className="text-xl mb-2 text-black">{college.name}</CardTitle>
                          ...
                          <CardContent className="space-y-4">
                            {/* Admission Stats */}
                            <div>
                              <h4 className="font-semibold text-black mb-3 text-base">Admission</h4>
                            ...
                            {/* Test Scores */}
                            <div>
                              <h4 className="font-semibold text-black mb-3 text-base">Test Scores</h4>
                              <div className="space-y-2">
                                <div className="flex items-center justify-between text-gray-700">
                                  <span className="text-sm">SAT Range</span>
                                  <span className="font-medium text-gray-500">{college.sat_range_25th}-{college.sat_range_75th}</span>
                                </div>
                                <div className="flex items-center justify-between text-gray-700">
                                  <span className="text-sm">ACT Range</span>
                                  <span className="font-medium text-gray-500">{college.act_range_25th}-{college.act_range_75th}</span>
                                </div>
                                <div className="flex items-center justify-between text-gray-700">
                                  <span className="text-sm">Avg GPA</span>
                                  <span className="font-medium text-gray-500">{college.gpa_average}</span>
                                </div>
                                {college.test_optional && (
                                  <Badge variant="outline"className="bg-green-100 text-green-900">Test Optional </Badge>
                                )}
                              </div>
                            </div>
                            ...
                            {/* Costs */}
                            <div>
                              <h4 className="font-semibold text-black mb-3 text-base">Costs</h4>
                              <div className="space-y-2">
                                <div className="flex items-center justify-between text-gray-700">
                                  <span className="text-sm">In-State Tuition</span>
                                  <span className="font-medium text-gray-500 text-sm">{formatCurrency(college.tuition_in_state)}</span>
                                </div>
                                <div className="flex items-center justify-between text-gray-700">
                                  <span className="text-sm">Out-of-State</span>
                                  <span className="font-medium text-gray-500 text-sm">{formatCurrency(college.tuition_out_state)}</span>
                                </div>
                                <div className="flex items-center justify-between text-gray-700">
                            ...
                            <div>
                              <h4 className="font-semibold text-black mb-3 text-base">Financial Aid</h4>
                              <div className="flex flex-wrap gap-2">
                                {college.need_blind_domestic && (
                                  <Badge variant="outline" className="text-xs border-white/20 text-gray-700">Need-Blind (US)</Badge>
                                )}
                                {college.need_blind_international && (
                                  <Badge variant="outline" className="text-xs border-white/20 text-gray-700">Need-Blind (Intl)</Badge>
                                )}
                                {college.meets_full_need && (
                                  <Badge variant="outline" className="text-xs border-white/20 text-gray-700">Meets Full Need</Badge>
                                )}
                                {college.no_loan_policy && (
                                  <Badge variant="outline" className="text-xs border-white/20 text-gray-700">No-Loan Policy</Badge>
                                )}
                              </div>
                            </div>
                            ...
                            {/* Campus Info */}
                            <div>
                              <h4 className="font-semibold text-black mb-3 text-base">Campus</h4>
                              <div className="space-y-2">
                                <div className="flex items-center justify-between text-gray-700">
                                  <span className="text-sm">Enrollment</span>
                                  <span className="font-medium text-gray-500">{college.undergraduate_enrollment?.toLocaleString()}</span>
                                </div>
                                <div className="flex items-center justify-between text-gray-700">
                                  <span className="text-sm">Setting</span>
                                  <span className="font-medium text-gray-500 capitalize">{college.campus_setting}</span>
                                </div>
                              </div>
                            </div>

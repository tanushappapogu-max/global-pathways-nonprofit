          ...
          >
            ...
            >
              <Link to="/auto-scholarships" className="w-full sm:w-auto">
                <button className="group w-full h-[90px] px-10 bg-blue-900 text-white rounded-xl text-xl font-bold shadow-lg hover:shadow-xl hover:bg-blue-900  hover:text-white transition-all duration-300 hover:scale-105">
              ...
              <Link to="/cost-calculator" className="w-full sm:w-auto">
                <button className="group w-full h-[90px] px-10 bg-white border-2 border-blue-900 text-blue-900 rounded-xl text-xl font-bold shadow-lg hover:bg-white hover:text-blue-900 hover:border-blue-900 transition-all duration-300 hover:scale-105">
                  <span className="flex items-center justify-center gap-3 whitespace-nowrap">

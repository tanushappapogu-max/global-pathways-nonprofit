-- Add comprehensive US college database with 200+ additional colleges
...
-- Texas Universities
('Rice University', 'Houston, TX', 'Texas', 't20', 8.7, 52070, 52070, 70566,
 4000, 'Common Application', '2025-01-01',
...
('Wake Forest University', 'Winston-Salem, NC', 'North Carolina', 't20', 22.0, 60876, 60876, 79910,
 5200, 'Common Application', '2025-01-01',
...
-- More State Universities from Various States
...
('Williams College', 'Williamstown, MA', 'Massachusetts', 'liberal_arts', 8.0, 61450, 79000,
 2000, 'Common Application', '2025-01-01',
 1440, 1570, 32, 35, 4.00,
 ARRAY['Economics', 'Psychology', 'Political Science', 'English', 'Art History'], 4, 'rural',
 'https://www.williams.edu', true),

('Amherst College', 'Amherst, MA', 'Massachusetts', 'liberal_arts', 7.0, 62765, 81000,
 1800, 'Common Application', '2025-01-01',
 1450, 1570, 32, 35, 4.00,
 ARRAY['Economics', 'Psychology', 'Political Science', 'English', 'Mathematics'], 4, 'suburban',
 'https://www.amherst.edu', true),

('Swarthmore College', 'Swarthmore, PA', 'Pennsylvania', 'liberal_arts', 6.0, 58928, 77000,
 1600, 'Common Application', '2025-01-01',
 1440, 1570, 32, 35, 4.00,
 ARRAY['Economics', 'Political Science', 'Biology', 'Psychology', 'Engineering'], 4, 'suburban',
 'https://www.swarthmore.edu', true),

('Pomona College', 'Claremont, CA', 'California', 'liberal_arts', 7.0, 58252, 77000,
 1700, 'Common Application', '2025-01-01',
 1440, 1570, 32, 35, 4.00,
 ARRAY['Economics', 'Psychology', 'Political Science', 'English', 'Mathematics'], 4, 'suburban',
 'https://www.pomona.edu', true),

('Bowdoin College', 'Brunswick, ME', 'Maine', 'liberal_arts', 9.0, 60952, 79000,
 1800, 'Common Application', '2025-01-01',
 1440, 1550, 32, 35, 4.00,
 ARRAY['Economics', 'Government', 'Psychology', 'English', 'Biology'], 4, 'suburban',
 'https://www.bowdoin.edu', true),

('Carleton College', 'Northfield, MN', 'Minnesota', 'liberal_arts', 19.0, 58968, 77000,
 2000, 'Common Application', '2025-01-15',
 1410, 1550, 32, 35, 3.90,
 ARRAY['Economics', 'Psychology', 'Political Science', 'Biology', 'Mathematics'], 4, 'suburban',
 'https://www.carleton.edu', true),

('Middlebury College', 'Middlebury, VT', 'Vermont', 'liberal_arts', 13.0, 61456, 79000,
 2500, 'Common Application', '2025-01-01',
 1410, 1550, 32, 35, 3.90,
 ARRAY['Economics', 'International Studies', 'Psychology', 'English', 'Environmental Studies'], 4, 'rural',
 'https://www.middlebury.edu', true),

('Wellesley College', 'Wellesley, MA', 'Massachusetts', 'liberal_arts', 16.0, 60840, 79000,
 2400, 'Common Application', '2025-01-01',
 1420, 1550, 32, 35, 3.90,
 ARRAY['Economics', 'Psychology', 'Political Science', 'English', 'International Relations'], 4, 'suburban',
 'https://www.wellesley.edu', true),

('Haverford College', 'Haverford, PA', 'Pennsylvania', 'liberal_arts', 18.0, 60896, 79000,
 1300, 'Common Application', '2025-01-15',
 1420, 1550, 32, 35, 3.90,
 ARRAY['Economics', 'Psychology', 'Political Science', 'Biology', 'English'], 4, 'suburban',
 'https://www.haverford.edu', true),

('Claremont McKenna College', 'Claremont, CA', 'California', 'liberal_arts', 10.0, 60480, 79000,
 1300, 'Common Application', '2025-01-01',
 1420, 1550, 32, 35, 3.90,
 ARRAY['Economics', 'Government', 'International Relations', 'Psychology', 'Philosophy'], 4, 'suburban',
 'https://www.cmc.edu', true);

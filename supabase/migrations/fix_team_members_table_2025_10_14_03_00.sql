-- Check if team members table exists and recreate if needed
...
('Dr. Lisa Wang', 'Head of Research', 'PhD in Education Policy from Stanford. Lisa conducts research on college access and affordability, ensuring our platform is backed by the latest academic insights.', '/images/team/lisa-wang.jpg', 'lisa@globalpathways.edu', 'https://linkedin.com/in/lisawang', 5),

('Ahmed Hassan', 'International Student Advisor', 'Former international student from Egypt who now helps other international students navigate the complex U.S. education system. Fluent in Arabic, English, and French.', '/images/team/ahmed-hassan.jpg', 'ahmed@globalpathways.edu', 'https://linkedin.com/in/ahmedhassan', 6);

-- Create index for better performance
CREATE INDEX IF NOT EXISTS idx_team_members_order ON public.team_members_2025_10_14_03_00(display_order);
CREATE INDEX IF NOT EXISTS idx_team_members_active ON public.team_members_2025_10_14_03_00(is_active);
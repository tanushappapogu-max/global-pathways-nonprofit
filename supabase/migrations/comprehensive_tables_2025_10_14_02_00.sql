-- Create comprehensive tables for full website functionality
...
-- Insert sample data
INSERT INTO public.user_profiles_2025_10_14_02_00 (user_id, full_name, email, country, education_level, field_of_study, gpa)
VALUES 
  (gen_random_uuid(), 'Sample Student', 'student@example.com', 'United States', 'High School', 'Computer Science', 3.8),
  (gen_random_uuid(), 'International Student', 'international@example.com', 'India', 'High School', 'Engineering', 3.9);
